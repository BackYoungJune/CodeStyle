...
namespace Dev_Unit
{
    public class UnitEnemy_MinJi : UnitEnemy
    {

        //--------------------------------------------------------					
        // 외부 참조 함수 & 프로퍼티					
        //--------------------------------------------------------					
        public void MaskDeactivation()
        {
            SmokeEffect.Play();
            Invoke("InvokeMaskChange", 0.3f);
        }

        void InvokeMaskChange()
        {
        ...
        [SerializeField] private GameObject MiniMask;
        ...
        {
            base.Awake();
            base.pUniqueID = UnitUniqueID.Enemy_MinJi;
        }
        ...
        protected override void OnEnable()
        {
            ...
            //if(GameManager.Instance.pCurPlayingAdventureChapter == Dev_SceneManagement.ChaptersDefines.Chapter_2)
            //{
            //    MiniMask.SetActive(false);
            //}
        }
