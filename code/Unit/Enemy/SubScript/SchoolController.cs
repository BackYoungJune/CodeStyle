...
public class SchoolController : MonoBehaviour
{
    ...
    // todo : 영준. 2023.06.01 - bubble 안나오도록 수정
    /////BUBBLES
    ...
    [SerializeField] public Object FollowCube;
    ...
    // todo : 영준. 2023.05.31 - Update에서 물고기가 FollowCube 따라가도록 수정
    public void UpdateMove()
    {
        _posBuffer = ((GameObject)FollowCube).transform.position;
    }
    ...
    {
        _schoolSpeed = Random.Range(1.0f, _childSpeedMultipler);
        // todo : 영준. 2023.05.31 - Update에서 따라가도록 할 것이기 떄문에 기존 랜덤으로 따라가도록 하는 코드 주석처리
