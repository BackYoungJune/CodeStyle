...
public class SchoolControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.EndVertical();
        // todo : 영준. 2023.05.31 - FollowCube 에디터로 받을 수 있도록 추가
        EditorGUILayout.LabelField("FollowCube", EditorStyles.boldLabel);
        target_cs.FollowCube = EditorGUILayout.ObjectField("FollowCube", target_cs.FollowCube, typeof(GameObject), true);
        // 여기까지
        GUI.color = dColor;
        EditorGUILayout.BeginVertical("Box");
        GUI.color = Color.white;
