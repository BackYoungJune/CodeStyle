...
namespace Dev_Unit
{
    public class UnitPlayer_Female : UnitPlayer
    {
        ...
        protected override void Update()
        {
            ...
            //{
            //    //TionXR_GestureManager.Instance.Perfect_Gesture();
            //    UnitManager.Instance.GetCurTargetExerciseUnit.ChangeStateMachine(ExerciseState.Prepare);
            //}
            //if (Input.GetKeyDown(KeyCode.W))
            //{
            //    //TionXR_GestureManager.Instance.Good_Gesture();
            //    UnitManager.Instance.GetCurTargetExerciseUnit.ChangeStateMachine(ExerciseState.Prepare);
            //}
            //}
        }
